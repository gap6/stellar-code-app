      ...
      <section id="contact" className="relative z-10 py-16 md:py-24 px-4">
        <div className="container mx-auto text-center max-w-2xl">
          ...
          <form className="space-y-6 text-left" onSubmit={(e) => e.preventDefault()}>
            ...
            <div className="text-center">
              <button type="button" className="cta-button inline-block bg-[var(--secondary-accent)] text-white font-bold py-4 px-10 rounded-full text-xl hover:bg-violet-700 transition duration-300 shadow-lg transform hover:scale-105">
                Send Message
              </button>
            </div>
          </form>
